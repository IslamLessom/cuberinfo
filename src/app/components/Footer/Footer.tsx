      ...
      <div className="footer-content">
        <div className="footer-top">
          ...
          <div className="footer-menu-group">
            <h4 className="footer-menu-title">Community</h4>
        ...
        <div className="footer-bottom">
          <div className="footer-copy">
            © 2024 CyberInfo. All rights reserved.
          </div>
          <div className="social-links">
            <a href="https://t.me/cyberguardkaz" className="social-link">
              <svg
                viewBox="0 0 24 24"
            ...
            <a href="https://discord.gg/8bH7xc8t" className="social-link">
              <svg
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
            ...
            <a
              href="https://www.instagram.com/cyberguardkaz?igsh=MWc0Y3o5ZndudzF4ZQ=="
