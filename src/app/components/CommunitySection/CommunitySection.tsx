...
const communityData = [
  {
    ...
    description:
      "Присоединяйтесь к нашему телеграм сообществу где мы делимся актуальными сведениями о кибер безопасности",
    link: "Присоединиться →",
  ...
  },
  {
    ...
    description:
      "Присоединяйтесь к нашему активному сообществу энтузиастов кибербезопасности на Discord и общайтесь с единомышленниками",
    link: "Присоединиться →",
  ...
  },
  {
    ...
    title: "Instagram",
    description:
      "Присоединчйтесь к нашему активному сообществу в интсаграмме , там мы делимся всеми новостями",
    link: "Смотреть  →",
    links: "https://www.instagram.com/cyberguardkaz?igsh=MWc0Y3o5ZndudzF4ZQ==",
  },
];
      ...
      <div className={styles.container}>
        <div className={styles.leftContent}>
          <h2 className={styles.title}>
            Присоединяйтесь к нашему процветающему обучающему сообществу!
          </h2>
          <p className={styles.subtitle}>
            Присоединяйтесь к нашему сообществу обучения, ориентированному на
            пользователя, где мы делаем цифровую безопасность доступной для
            всех. Помощь в прогрессе, защищая наше будущее.
          </p>
